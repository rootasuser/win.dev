  ...
  <div class="row">
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm d-flex flex-column h-100">
        <img src="src/assets/images/BMS.png" class="card-img-top" alt="">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm d-flex flex-column h-100">
        <img src="src/assets/images/DTS.png" class="card-img-top" alt="">
        <div class="card-body d-flex flex-column">
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm d-flex flex-column h-100">
        <img src="src/assets/images/OJT.png" class="card-img-top" alt="">
        <div class="card-body d-flex flex-column">
